...
private:
    ...
    ros::Publisher _motor_position_pub;
    rosee_msg::MotorCurrent _motor_position_msg;
    int _motor_position_seq_id = 0;
    void fill_publish_motor_position();
    
    ros::Publisher _motor_positionDesired_pub;
